...
def qwerty():
    ...
    def  reboot_controller():
        ...
        if (control_edit==0 or control_memory_mode==6):
            ...
            canvas.create_polygon(ras*10.4,ras*7.15,ras*10.3,ras*7.05,ras*10.35,ras*7.05,ras*10.35,ras*6.85,ras*10.43,ras*6.85,ras*10.43,ras*7.05,ras*10.5,ras*7.05, fill="white", outline="black")
            canvas.create_polygon(ras*10.5,ras*6.95,ras*10.6,ras*6.85,ras*10.7,ras*6.95,ras*10.63,ras*6.95,ras*10.63,ras*7.15,ras*10.55,ras*7.15,ras*10.55,ras*6.95, fill="white", outline="black")
            #canvas.create_rectangle(ras*10.35,ras*7.1,ras*10.43,ras*6.85,fill="white", outline="black")
            #canvas.create_rectangle(ras*10.38,ras*7.2,ras*10.40,ras*6.85,fill="white", outline="white")
