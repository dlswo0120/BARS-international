...
def qwerty():
    ...
    out_window = Tk()
    out_window.title('BARS 1.0')  # demonstration
        ...
        def eating(area_operation, go_color, y, x):
            ...
            if(1):
                if (area[y][x]==go_color): # proverka na vozmognost siest shaskami
                    if (y-2>=0 and x-2>=0): # and area[y][x]/10<1
        ...
        while (y<=7):
            ...
            if(0):
                if (fl==1):
                    ...
                    go_operation[len(go_operation)-1][0] = go_color*100+y*10+x 
                fl = eating(area[y][x], go_color, y ,x)
