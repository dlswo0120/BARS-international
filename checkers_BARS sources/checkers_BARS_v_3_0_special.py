...
debuts = [["name",                             [[9, 0, 9, 0, 9, 0, 9, 0],
          ...
          ["обратный перекресток",             [[9, 2, 9, 2, 9, 2, 9, 2],
                                                [2, 9, 2, 9, 0, 9, 2, 9],
                                                [9, 2, 9, 2, 9, 2, 9, 2],
                                                [0, 9, 0, 9, 2, 9, 0, 9],
                                                [9, 0, 9, 1, 9, 0, 9, 1],
          ...
          ["игра Рамма-Цукерника",             [[9, 2, 9, 2, 9, 2, 9, 2],
                                                [2, 9, 2, 9, 2, 9, 0, 9],
                                                [9, 2, 9, 2, 9, 2, 9, 0],
                                                [0, 9, 0, 9, 0, 9, 1, 9],
                                                [9, 0, 9, 1, 9, 0, 9, 2],
          ...
          ["Киевская защита",                  [[9, 2, 9, 2, 9, 2, 9, 2],
                                                [2, 9, 2, 9, 2, 9, 2, 9],
                                                [9, 2, 9, 2, 9, 0, 9, 0],
                                                [0, 9, 0, 9, 0, 9, 2, 9],
                                                [9, 1, 9, 1, 9, 0, 9, 2],
          ...
          ["Ленинградская защита",             [[9, 2, 9, 2, 9, 2, 9, 2],
                                                [2, 9, 2, 9, 2, 9, 2, 9],
                                                [9, 0, 9, 2, 9, 0, 9, 2],
                                                [2, 9, 0, 9, 0, 9, 0, 9],
                                                [9, 1, 9, 1, 9, 0, 9, 2],
...
def qwerty():
    ...
    out_window = Tk()
    out_window.title('BARS 3.0 special')  # demonstration special
        ...
        if (control_edit==0):
            ...
            if (go_error==11):
                ...
                if (go_error==1):
                    ...
                    canvas.create_text(ras*10.5,ras*7,text="сейчас ходит другой игрок",font="Verdana 8",justify=CENTER,fill="black")
            # for special version:
            canvas.create_rectangle(ras*9.25,ras*7.5,ras*11.75,ras*8.0,fill="white")
            canvas.create_text(ras*10.5,ras*7.75,text="вывести протокол",font="Verdana 8",justify=CENTER,fill="black")
        else:
            # остальные кнопки
        ...
        if (klik_flag==1):
            ...
            if ((x >= ras/2) and (x <= ras/2*17) and (y >= ras/2) and (y <= ras/2*17)): 
                ...
                if (control_edit==0):
                    ...
                    # for special version
                    if (x>=ras*9.25 and x<=ras*11.75 and y>=ras*7.5 and y<=ras*8.0):
                        print_file()
                        print("------------------------------------")
                else:
