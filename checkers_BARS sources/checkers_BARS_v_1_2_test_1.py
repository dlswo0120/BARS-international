        ...
        while (y < 8):
            ...
            while (x < 8): 
                if ((area[y][x] != 9) and (area[y][x] != 0)):
                    ...
                    if (area[y][x]>100):
                        if (area[y][x]%10==1):
                            #canvas.create_line(x*ras+ras*0.6,y*ras+ras*0.6,(x+1)*ras+ras*0.4,(y+1)*ras+ras*0.4,width=2,fill="#c96")
                            #canvas.create_line((x+1)*ras+ras*0.4,y*ras+ras*0.6,x*ras+ras*0.6,(y+1)*ras+ras*0.4,width=2,fill="#c96")
                            #canvas.create_line((x+1)*ras+ras*0,y*ras+ras*0.5,(x+1)*ras+ras*0,(y+1)*ras+ras*0.5,width=2,fill="#c96")
                            #canvas.create_line((x+0)*ras+ras*0.5,(y+1)*ras+ras*0,(x+1)*ras+ras*0.5,(y+1)*ras+ras*0,width=2,fill="#c96")
                            ...
                            canvas.create_line(x*ras+ras*0.8,y*ras+ras*0.8,(x+1)*ras+ras*0.2,(y+1)*ras+ras*0.2,width=5,fill="#c96")
                            canvas.create_line((x+1)*ras+ras*0.2,y*ras+ras*0.8,x*ras+ras*0.8,(y+1)*ras+ras*0.2,width=5,fill="#c96")
