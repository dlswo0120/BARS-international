...
def qwerty():
    ...
    def click1(event):
        ...
        if (klik_flag==1):
            ...
            # control_protocol
            # control_protocol_flag
            # control_actions
            # control_actions_flag
            if (len(history)>1):
                control_protocol.clear()
                control_protocol_flag = len(history) - 1
                i = 0
    ...
    def click3(event):
        ...
        if (x>=ras*9.25 and x<=ras*11.75 and y>=ras*0.5 and y<=ras*3.5):
            #print("1234567890")
            if (len(history)>1):
                control_protocol.clear()
                ...
                control_protocol.clear()
                control_protocol_flag = 0
        if (x>=ras*9.25 and x<=ras*11.75 and y>=ras*4 and y<=ras*6):
