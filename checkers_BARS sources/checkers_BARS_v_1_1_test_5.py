...
def qwerty():
    ...
    def no_wins(area, go_color):
        global go_operation
        generator_move(area, go_color) # убрать отсюда и вернуть в исходные функции 
        flag = 1
    ...
    def mozg_random():
        ...
        i = 1
        go_error = 0
        #generator_move(go_color)
        if (no_wins(area_monitor, go_color)):
