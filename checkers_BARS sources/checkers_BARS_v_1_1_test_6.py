        ...
        if (control_edit==0):
            ...
            if (control_vs==1 and go_color==2 or control_vs==2 and go_color==1 or control_vs==3):
                if (go_error==1):
                    ...
                    canvas.create_text(ras*7,ras*9.5,text="white wins!",font="Verdana 10",justify=CENTER,fill="black")
                elif (go_error==12):
                    canvas.create_text(ras*7,ras*9.5,text="black wins!",font="Verdana 10",justify=CENTER,fill="black")
            elif (go_error==11):
                canvas.create_text(ras*7,ras*9.5,text="white wins!",font="Verdana 10",justify=CENTER,fill="black")
            elif (go_error==12):
                canvas.create_text(ras*7,ras*9.5,text="black wins!",font="Verdana 10",justify=CENTER,fill="black")
                ...
                if ((area[y][x] != 9) and (area[y][x] != 0)):
                    ...
                    if (area[y][x]%10==1):
                        if (moved_checkers==y*10+x):
                            ...
                            canvas.create_oval([x*ras+ras/2+ras/10,(y-1)*ras+ras/2*3+ras/10],[x*ras+ras/2*3-ras/10,(y-1)*ras+ras/2*5-ras/10],fill="white", outline="blue")
                        else:
                        ...
                        if (moved_checkers==y*10+x):
                            canvas.create_oval([x*ras+ras/2+ras/10,(y-1)*ras+ras/2*3+ras/10],[x*ras+ras/2*3-ras/10,(y-1)*ras+ras/2*5-ras/10],fill="grey", outline="red")
                        elif (go_color==2):
                            canvas.create_oval([x*ras+ras/2+ras/10,(y-1)*ras+ras/2*3+ras/10],[x*ras+ras/2*3-ras/10,(y-1)*ras+ras/2*5-ras/10],fill="grey", outline="blue")
                        else:
                    ...
                    if (area[y][x]>100):
                        #canvas.create_line(x*ras+ras*0.6,y*ras+ras*0.6,(x+1)*ras+ras*0.4,(y+1)*ras+ras*0.4,width=5,fill="black")
                        #canvas.create_line((x+1)*ras+ras*0.4,y*ras+ras*0.6,x*ras+ras*0.6,(y+1)*ras+ras*0.4,width=5,fill="black")
                        canvas.create_line(x*ras+ras*0.8,y*ras+ras*0.8,(x+1)*ras+ras*0.2,(y+1)*ras+ras*0.2,width=5,fill="black")
                        canvas.create_line((x+1)*ras+ras*0.2,y*ras+ras*0.8,x*ras+ras*0.8,(y+1)*ras+ras*0.2,width=5,fill="black")
                x = x + 1
            y = y + 1
            #out_window.update()
