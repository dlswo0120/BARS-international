...
def qwerty():
    ...
    def  reboot_controller():
        ...
        global go_error
        global control_back
        #canvas.create_rectangle(0,ras*9,ras*12,ras*10,fill="white") #
        canvas.create_rectangle(ras*9,0,ras*12,ras*9,fill="white")
        control_edit = 1
        if (control_edit==0):
            ...
            # остальные кнопки
            canvas.create_text(ras*10.5,ras*0.25,text="расстановка позиции",font="Verdana 8",justify=CENTER,fill="black")
            ...
            canvas.create_text(ras*10.5,ras*3.75,text="первый ход",font="Verdana 8",justify=CENTER,fill="black")
            if (control_move==1 and 0):
                canvas.create_rectangle(ras*10.625,ras*4,ras*11.75,ras*4.5,fill="white", outline="black")
                canvas.create_text(ras*11.1875,ras*4.25,text="белые",font="Verdana 8",justify=CENTER,fill="black")
                canvas.create_rectangle(ras*9.25,ras*4,ras*10.375,ras*4.5,fill="white", outline="grey")
                canvas.create_text(ras*9.8125,ras*4.25,text="черные",font="Verdana 8",justify=CENTER,fill="grey")
            elif (0):
                canvas.create_rectangle(ras*10.625,ras*4,ras*11.75,ras*4.5,fill="white", outline="grey")
                canvas.create_text(ras*11.1875,ras*4.25,text="белые",font="Verdana 8",justify=CENTER,fill="grey")
                canvas.create_rectangle(ras*9.25,ras*4,ras*10.375,ras*4.5,fill="white", outline="black")
                canvas.create_text(ras*9.8125,ras*4.25,text="черные",font="Verdana 8",justify=CENTER,fill="black")
            canvas.create_text(ras*10.5,ras*4.75,text="режим игры",font="Verdana 8",justify=CENTER,fill="black")
                ...
                if (control_edit==0):
                    ...
                    if (area_monitor[y][x]==0):
                        ...
                        if (control_edit_checkers[0]==y and control_edit_checkers[1]==x):
                            ...
                            control_edit_checkers = [y,x,1]
                        if (area_monitor[y][x]/10<1):
                            area_monitor[y][x] = area_monitor[y][x] + 10
                        else:
                            if (control_edit_checkers[2]>3):
                                area_monitor[y][x] = 0
                                ...
                                area_monitor[y][x] = 1
                        if (area_monitor[y][x]!=0):
                            control_add = area_monitor[y][x]%10
            else:
